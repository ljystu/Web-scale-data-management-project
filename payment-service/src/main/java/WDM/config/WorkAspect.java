...
public class WorkAspect {
    ...
    @Before("execution(* WDM.service.PaymentService.pay())")
    ...
    @AfterThrowing(throwing = "e", pointcut = "execution(* WDM.service.PaymentService.pay())")
    ...
    @AfterReturning(value = "execution(* WDM.service.PaymentService.pay())", returning = "result")
