...
public class WorkAspect {
    ...
    @Before("execution(* WDM.service.Impl.OrderServiceImpl.checkout())")
    ...
    @AfterThrowing(throwing = "e", pointcut = "execution(* WDM.service.Impl.OrderServiceImpl.checkout())")
    ...
    @AfterReturning(value = "execution(* WDM.service.Impl.OrderServiceImpl.checkout())", returning = "result")
